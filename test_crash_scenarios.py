...
Usage
-----
    python test_crash_scenarios.py            # run all 7 in order
    python test_crash_scenarios.py -s 6       # run one scenario
    python test_crash_scenarios.py --run 6    # internal: direct execution (subprocess use)
...
def scenario_2():
    ...
    log(f"S2 | All 30 clients created without crash — releasing...")
    del accumulated
...
def scenario_8():
    ...
    sensor or releasing the client first (original notebook behaviour).
...
def scenario_9():
    ...
    This mirrors the FIXED notebook behaviour.
